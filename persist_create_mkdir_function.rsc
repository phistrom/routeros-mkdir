{
    ...
    /system script
    add dont-require-permissions=no name=create_mkdir_function owner=stromberg policy=read,write,policy,test source="# Written by Phillip Stromberg in 2019\r\
        \n# Distributed under the MIT license\r\
        \n# \r\
        \n# \r\
        \n# this creates a function called \$mkdir\r\
        \n# from the command line you will be able to just type \"\$mkdir some/new/folder\"\r\
        ...
        \n    :local errorMsg;\r\
        \n\r\
        \n    # if the user put a slash on the end of the new folder name, remove it\r\
        \n    # i.e. \"some/test/\" becomes \"some/test\"\r\
        \n    :while (([:pick \$newFolder ([:len \$newFolder] - 1)]) = \"/\") do={\r\
        \n        :set newFolder [:pick \$newFolder 0 ([:len \$newFolder] - 1)]\r\
        \n    }\r\
        \n\r\
        \n    # if the user put a slash at the beginning of the new folder name, remove it\r\
        \n    # i.e. \"/some/test\" becomes \"some/test\"\r\
        ...
        \n        # the :error command seems to be the only way to break out of a script\r\
        ...
        \n    # wrapping in a `:do {...} on-error` prevents error messages from printing.\r\
        \n    :do {\r\
        \n        /tool fetch dst-path=\"\$fullTempPath\" url=\"\$fakeURL\" duration=0.001s as-value;\r\
        \n    } on-error={}\r\
        \n\r\
        \n    # this waits for the temporary dir to show up so there isn't a race \r\
        \n    # condition where you call mkdir and then try to do something before the \r\
        \n    # folder is actually created\r\
        \n    :local count 0;\r\
        \n    :while ([/file find name=\"\$newFolder\"] = \"\") do={\r\
        \n        :if (\$count >= 50) do={\r\
        \n            # after 50 * 0.1s delays, it's been 5 seconds, which should be long enough\r\
        \n            :set errorMsg \"New folder could not be created at \$newFolder\";\r\
